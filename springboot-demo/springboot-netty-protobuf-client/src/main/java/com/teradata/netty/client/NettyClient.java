package com.teradata.netty.client;

import java.util.concurrent.TimeUnit;

import com.teradata.netty.client.handler.IdleClientHandler;
import com.teradata.netty.client.handler.LogicClientHandler;
