...
public class Utils {
	public static final String YARNAPP_JAR_NAME = "yarn-app.jar";
	public static final Path YARNAPP_JAR_PATH = new Path("hdfs://localhost:8020/user/root/apps/" + YARNAPP_JAR_NAME);
