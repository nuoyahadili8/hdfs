package com.teradata.hadoop.hdfs.web;


import com.google.gson.Gson;
import com.sun.deploy.util.URLUtil;
import com.teradata.hadoop.security.HttpsHostnameVerifier;
import com.teradata.hadoop.security.HttpsX509TrustManager;
...
public class KerberosWebHDFSConnection implements WebHDFSConnection {
    ...
    protected static final Logger Log = LoggerFactory.getLogger(KerberosWebHDFSConnection.class);
    ...
    public KerberosWebHDFSConnection(String httpfsUrl, String krb5Conf, String keytab, String principal) {
